...
{
    /// <inheritdoc />
    public partial class Buplic : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Faculties_AcademicYear_AYId",
                        column: x => x.AYId,
                        principalSchema: "dbo",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Buplic = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Filepath = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
                    ImageFilePath = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contributions_FeedbackId",
                schema: "dbo",
                table: "Contributions",
                column: "FeedbackId");
